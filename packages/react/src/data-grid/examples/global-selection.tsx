...
import { Badge, Button, Checkbox, Pagination, Table } from "@pisagor/react";
import type { RowData } from "@tanstack/react-table";
import { type ReactNode, useMemo, useState } from "react";
import type { ColumnDef, PaginationState, RowSelectionState } from "..";
...
function GlobalSelectionSummary<TData extends RowData>({
  onClear,
}: {
  onClear: () => void;
}) {
  return <SelectionSummary<TData> onClear={onClear} />;
}

export function GlobalSelection() {
