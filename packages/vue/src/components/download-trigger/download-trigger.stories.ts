...
export const Default = meta.story({
  render: () => ({
    ...
    setup() {
      return { text: "Hello, World! This is a sample text file." };
    },
    template: `
