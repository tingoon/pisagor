...
export function BottomNavigationRoot(props: BottomNavigationRootProps): JSX.Element {
...
export function BottomNavigationList(props: BottomNavigationListProps): JSX.Element {
  const [local, rest] = splitProps(props, ["class"]);
  const { slots } = useBottomNavigation();
  return <TabsPrimitive.List {...rest} class={slots.list({ class: cn(local.class) })} />;
}

export function BottomNavigationItem(props: BottomNavigationItemProps): JSX.Element {
  ...
  return (
    <BottomNavigationItemContext value={{ slots: slots() }}>
      <TabsPrimitive.Trigger {...rest} class={slots().base({ class: cn(local.class) })}>
        {local.children}
...
export function BottomNavigationItemIcon(props: BottomNavigationItemIconProps): JSX.Element {
  const [local, rest] = splitProps(props, ["class"]);
...
export function BottomNavigationItemLabel(props: BottomNavigationItemLabelProps): JSX.Element {
  const [local, rest] = splitProps(props, ["class"]);
  const { slots } = useBottomNavigationItem();
  return (
    <ark.span
