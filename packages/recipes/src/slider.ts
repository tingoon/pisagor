...
export const sliderRecipe = tv({
  slots: {
    ...
    thumb: [
      ...
      "focus-visible:border-primary focus-visible:outline-hidden focus-visible:ring-0.75 focus-visible:ring-ring/32",
      "origin-left data-dragging:scale-110 data-dragging:cursor-grabbing data-dragging:border-primary data-dragging:ring-0.75 data-dragging:ring-ring/32",
...
export type SliderRecipeFn = typeof sliderRecipe;
export type SliderRecipe = ReturnType<SliderRecipeFn>;
