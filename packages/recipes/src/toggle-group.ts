...
export type ToggleGroupRecipeFn = typeof toggleGroupRecipe;
export type ToggleGroupVariantProps = VariantProps<ToggleGroupRecipeFn>;
export type ToggleGroupRecipe = ReturnType<ToggleGroupRecipeFn>;
