...
export const imageCropperRecipe = tv({
  slots: {
    ...
    handleGrip: ["block size-(--cropper-handler-size)"],
    image: [
...
export type ImageCropperRecipeFn = typeof imageCropperRecipe;
export type ImageCropperRecipe = ReturnType<ImageCropperRecipeFn>;
