...
export type DrawerRecipeFn = typeof drawerRecipe;
export type DrawerVariantProps = VariantProps<DrawerRecipeFn>;
export type DrawerRecipe = ReturnType<DrawerRecipeFn>;
