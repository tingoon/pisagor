...
export type PhoneInputRecipeFn = typeof phoneInputRecipe;
export type PhoneInputVariantProps = VariantProps<PhoneInputRecipeFn>;
export type PhoneInputRecipe = ReturnType<PhoneInputRecipeFn>;
