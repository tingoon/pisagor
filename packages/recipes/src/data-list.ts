...
export const dataListRecipe = tv({
  base: ["group/data-list", "flex flex-col gap-1", "text-sm"],
});

export const dataListItemRecipe = tv({
  slots: {
    base: [
      "flex gap-4 py-2",
...
export type DataListRecipeFn = typeof dataListRecipe;
export type DataListRecipe = ReturnType<DataListRecipeFn>;
export type DataListRecipeSlot = keyof DataListRecipe;

export type DataListItemRecipeFn = typeof dataListItemRecipe;
export type DataListItemRecipe = ReturnType<DataListItemRecipeFn>;
