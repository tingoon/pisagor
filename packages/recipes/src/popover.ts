...
export const popoverRecipe = tv({
  slots: {
    ...
    title: ["font-semibold text-base leading-tight tracking-tight"],
  },
});

export type PopoverRecipeFn = typeof popoverRecipe;
export type PopoverRecipe = ReturnType<PopoverRecipeFn>;
