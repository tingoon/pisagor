...
export type InputGroupAddonRecipeFn = typeof inputGroupAddonRecipe;
export type InputGroupAddonVariantProps = VariantProps<InputGroupAddonRecipeFn>;
export type InputGroupAddonRecipe = ReturnType<InputGroupAddonRecipeFn>;
...
export type InputGroupTextRecipeFn = typeof inputGroupTextRecipe;
export type InputGroupTextRecipe = ReturnType<InputGroupTextRecipeFn>;
export type InputGroupTextRecipeSlot = keyof InputGroupTextRecipe;

export type InputGroupControlRecipeFn = typeof inputGroupControlRecipe;
