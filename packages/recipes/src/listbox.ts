...
export type ListboxRecipeFn = typeof listboxRecipe;
export type ListboxRecipe = ReturnType<ListboxRecipeFn>;
export type ListboxRecipeSlot = keyof ListboxRecipe;

export type ListboxItemRecipeFn = typeof listboxItemRecipe;
export type ListboxItemVariantProps = VariantProps<ListboxItemRecipeFn>;
export type ListboxItemRecipe = ReturnType<ListboxItemRecipeFn>;
