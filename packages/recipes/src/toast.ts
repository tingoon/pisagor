...
export const toastItemRecipe = tv({
  slots: {
    ...
    base: [
      ...
      "bg-popover/88 backdrop-blur-xl backdrop-saturate-150",
...
export type ToastRecipeFn = typeof toastRecipe;
export type ToastRecipe = ReturnType<ToastRecipeFn>;
export type ToastRecipeSlot = keyof ToastRecipe;

export type ToastItemRecipeFn = typeof toastItemRecipe;
export type ToastItemRecipe = ReturnType<ToastItemRecipeFn>;
