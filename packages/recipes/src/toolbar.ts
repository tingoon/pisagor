...
export const toolbarRecipe = tv({
  slots: {
    ...
    base: [
      "group/toolbar",
      "flex w-full flex-wrap items-start justify-between gap-3",
    ],
...
export type ToolbarRecipeFn = typeof toolbarRecipe;
export type ToolbarRecipe = ReturnType<ToolbarRecipeFn>;
