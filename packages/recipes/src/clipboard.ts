...
export type ClipboardRecipeFn = typeof clipboardRecipe;
export type ClipboardVariantProps = VariantProps<ClipboardRecipeFn>;
export type ClipboardRecipe = ReturnType<ClipboardRecipeFn>;
