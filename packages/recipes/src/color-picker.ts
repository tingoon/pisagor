...
export const colorPickerRecipe = tv({
  slots: {
    ...
    areaThumb: [
      "size-4.5",
      "rounded-full border-0.75 border-white shadow-[0_0_0_1px_rgba(0,0,0,0.1),inset_0_0_0_1px_rgba(0,0,0,0.1)]",
...
export type ColorPickerRecipeFn = typeof colorPickerRecipe;
export type ColorPickerRecipe = ReturnType<ColorPickerRecipeFn>;
