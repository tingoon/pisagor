...
export type StepsRecipeFn = typeof stepsRecipe;
export type StepsRecipe = ReturnType<StepsRecipeFn>;
export type StepsRecipeSlot = keyof StepsRecipe;

export type StepsItemRecipeFn = typeof stepsItemRecipe;
export type StepsItemRecipe = ReturnType<StepsItemRecipeFn>;
