...
export const richTextEditorToolbarVariants = tv({
  base: ["flex flex-wrap items-center gap-1 border-border border-b bg-muted/30 px-2 py-1.5"],
});

export const richTextEditorContentVariants = tv({
  base: [
