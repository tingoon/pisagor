...
export const TablePagination = defineComponent({
  ...
  setup(props) {
    ...
    return () =>
      h(
        "div",
        { class: cn("flex flex-col gap-2 rounded-xl border p-4", props.class) },
        () => [
          ...
          h(
            "div",
            { class: "flex items-center justify-between gap-22" },
            () => [
                ...
                h(
                  Select as ArkPart,
                  {
                    ...
                    onValueChange: (value: string | string[]) => {
                      ...
                      pageSize.value = Number.isNaN(next)
                        ? pageSize.value
                        : next;
                    },
                  },
              ...
              h(
                Pagination as ArkPart,
                {
                  ...
                  onPageSizeChange: (details: { pageSize?: number }) => {
                    if (typeof details?.pageSize === "number")
                      pageSize.value = details.pageSize;
                  },
                  page: page.value,
